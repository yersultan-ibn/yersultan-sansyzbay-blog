...
const PostCardContent = () => {
  return (
    <div className="rounded-[13px] px-8 pb-0 py-8 bg-post-pattern bg-cover h-[600px] bg-center w-full text-white">
      <div className="flex flex-col justify-end h-full relative">
        ...
        <h3 className="font-semibold text-[30px] pb-5">React Library</h3>
        ...
        <div className="block lg:flex items-center mb-8 w-full">
          <div className="flex items-center justify-center mb-4 lg:mb-0 w-full lg:w-auto mr-8">
            <Image
              ...
              src={"/author-main.jpg"}
            />
            <p className="ml-2 font-light text-[15px]">Yersultan Sansyzbay</p>
          </div>
